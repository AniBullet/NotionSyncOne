...
<details>
<summary><b>⚠️ 安装时弹出「Windows 已保护你的电脑」警告？</b></summary>

**这是正常现象，应用本身完全安全。**

**原因**：本应用未购买 Windows 代码签名证书，Windows Defender SmartScreen 会对所有来自互联网的未签名 exe 显示此提示。

**解决步骤**：
1. 在弹出的绿色警告框中点击 **「更多信息」**
2. 再点击 **「仍要运行」** 即可正常安装

**说明**：同一台电脑上只需操作一次，之后不再弹出。每次发布新版本，新版 exe 首次运行时会再次出现，处理方式相同。
